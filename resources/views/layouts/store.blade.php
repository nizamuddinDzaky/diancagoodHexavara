...
<body>
    <header class="main_menu pr-5 pl-5">
                ...
                <div>
                    <ul class="nav">
                        <li class="nav-item dropdown pr-2">
                            <a type="button" class="nav-link" href="#" tabindex="-1" aria-disabled="true"><i class="fa-shopping-cart" aria-hidden="true"></i></a>
                        </li>
                        <li class="nav-item dropdown pl-3">
                            <a type="button" class="nav-link btn btn-outline-orange rounded-pill waves-effect" href="#" tabindex="-1" aria-disabled="true">Login</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row pl-4">
                ...
                <div class="col-md-3 mb-md-0 mb-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <br>
                        <li><h5 class="text-uppercase">SOSIAL MEDIA</h5></li>
                    </ul>
                </div>
                <!-- Grid column -->
            </div>
