                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-check text-gray-2 my-4">
                                    <input class="form-check-input position-static align-top primary-checkbox"
                                        type="checkbox" name="cd[]" id="check{{ $cd->id }}" value="{{ $cd->id }}"
                                        onclick="selectCart({{ $cd->id }})">
