            ...
            <div class="container text-gray-2">
                <div id="">
                    ...
                    <div class="row my-2 pb-3" id="#noAddress">
                        <div class="col">
                            <a type="button" class="btn btn-outline-orange" href="" aria-disabled="true"
                                data-toggle="modal" data-target="#addressModal">Buat Alamat Baru</a>
                        </div>
                    </div>
                    @endif
                    @if (auth()->guard('customer')->user()->address != 0)
                    <div id="#hasAddress">
                        ...
                        <div class="row my-2 pl-3">
                            <a type="button" class="btn btn-outline-orange" href="" aria-disabled="true"
                                data-toggle="modal" data-target="#editAddress">Edit Alamat</a>
                        </div>
                    </div>
                    @endif
                </div>
                            ...
                            <div class="col-lg-12 pb-1">
                                ...
                                <div class="card shadow-1 mb-3" style="width: 47rem">
                                    ...
                                    <div class="row px-4 py-2" style="height: 60px">
                                        ...
                                        <div class="col-lg-3">
                                            <div id="edit-btn">
                                                <button class="btn btn-outline-orange float-right" aria-disabled="true"
                                                    onclick="show()">Edit</button>
                                                <!-- <a type="button" class="btn btn-outline-orange float-right" href="#" onclick="toggle_visibility" aria-disabled="true">Edit</a> -->
                                            </div>
                            ...
                            <div class="cart-inner">
                                <div class="out_button_area">
                                    <div class="checkout_btn_inner">
                                        <a class="btn btn-outline-secondary" style="width: 7rem; height:40px"
                                            href="">Batal</a>
                                        <a class="btn btn-outline-orange bg-orange" style="color: white" href=""
                                            id="add-address">Tambah</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    <div class="cart_inner">
                        <form action="{{ route('checkout.updateAddress', $address->id) }}" method="post"
                            id="address-form">
                            @csrf
                            <div class="form-group pl-2 pr-2 pb-3">
                                <label>Jenis Alamat</label><br>
...
//     var e = document.getElementById("edit-btn");
